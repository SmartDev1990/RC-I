...
export const getCakeContract = (signer?: Signer | Provider) => {
  return getContract(cakeAbi, tokens.rice.address, signer) as Cake
}
...
export const getLotteryV2Contract = (signer?: Signer | Provider) => {
  return null // getContract(lotteryV2Abi, getLotteryV2Address(), signer) as LotteryV2
}
...
export const getMasterchefV1Contract = (signer?: Signer | Provider) => {
  return null // getContract(masterChefV1, getMasterChefV1Address(), signer) as MasterchefV1
}
